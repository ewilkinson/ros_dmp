"""autogenerated by genpy from ubot_dmp/DMPActionFeedback.msg. Do not edit."""
import sys
...
class DMPActionFeedback(genpy.Message):
  _md5sum = "25bfb21ced59f4f9490772d56f6961f4"
  _type = "ubot_dmp/DMPActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ubot_dmp/DMPFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DMPActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = ubot_dmp.msg.DMPFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ubot_dmp.msg.DMPFeedback()
