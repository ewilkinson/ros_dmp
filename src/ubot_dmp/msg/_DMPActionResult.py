"""autogenerated by genpy from ubot_dmp/DMPActionResult.msg. Do not edit."""
import sys
...
class DMPActionResult(genpy.Message):
  _md5sum = "b1e7c7d2130a3f55cb08f2784cabc793"
  _type = "ubot_dmp/DMPActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ubot_dmp/DMPResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DMPActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = ubot_dmp.msg.DMPResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ubot_dmp.msg.DMPResult()
