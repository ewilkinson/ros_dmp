"""autogenerated by genpy from ubot_dmp/DMPAction.msg. Do not edit."""
import sys
...
class DMPAction(genpy.Message):
  _md5sum = "22b92031e95baa1356148d753e55f025"
  _type = "ubot_dmp/DMPAction"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

DMPActionGoal action_goal
DMPActionResult action_result
DMPActionFeedback action_feedback

================================================================================
MSG: ubot_dmp/DMPActionGoal
...
================================================================================
MSG: ubot_dmp/DMPResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
# define the result message
uint32 success

================================================================================
MSG: ubot_dmp/DMPActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======

Header header
actionlib_msgs/GoalStatus status
DMPFeedback feedback

================================================================================
MSG: ubot_dmp/DMPFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
"""
  ...
  _slot_types = ['ubot_dmp/DMPActionGoal','ubot_dmp/DMPActionResult','ubot_dmp/DMPActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DMPAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = ubot_dmp.msg.DMPActionGoal()
      if self.action_result is None:
        self.action_result = ubot_dmp.msg.DMPActionResult()
      if self.action_feedback is None:
        self.action_feedback = ubot_dmp.msg.DMPActionFeedback()
    else:
      self.action_goal = ubot_dmp.msg.DMPActionGoal()
      self.action_result = ubot_dmp.msg.DMPActionResult()
      self.action_feedback = ubot_dmp.msg.DMPActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.goal_pos)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.action_goal.goal.goal_pos))
      _x = self
      buff.write(_struct_if.pack(_x.action_goal.goal.bitmask, _x.action_goal.goal.tau))
      _x = self.action_goal.goal.dmp_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.shelf
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.section
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.goal_pos = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 8
      (_x.action_goal.goal.bitmask, _x.action_goal.goal.tau,) = _struct_if.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.dmp_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.dmp_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.shelf = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.shelf = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.section = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.section = str[start:end]
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(self.action_goal.goal.goal_pos.tostring())
      _x = self
      buff.write(_struct_if.pack(_x.action_goal.goal.bitmask, _x.action_goal.goal.tau))
      _x = self.action_goal.goal.dmp_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.goal_pos = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      _x = self
      start = end
      end += 8
      (_x.action_goal.goal.bitmask, _x.action_goal.goal.tau,) = _struct_if.unpack(str[start:end])
